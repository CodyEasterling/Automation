...
describe('delete clinical interest', function() {
  it('should delete the previously created clinical interest', function() {

//navigate to Education Types
browser.get('https://csqa01.influencehealth.com/Phoenix/admin/v1/modules/provider/clinicalInterests');
